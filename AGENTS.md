...
Create pending changelog files under `.tegami/changes/` as `YYYY-MM-DD-{hash}.md`.
...
- Do not edit the publish lock file (`.tegami/changes/publish-lock.yaml`) or package `CHANGELOG.md` files directly
